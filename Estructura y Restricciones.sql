...
INSERT INTO Cancion VALUES (1, 'Let It Be', 243, TO_DATE('1970-05-08','YYYY-MM-DD'), 1, 1);
INSERT INTO Cancion VALUES (2, 'Anti-Hero', 200, TO_DATE('2022-10-21','YYYY-MM-DD'), 2, 2);
INSERT INTO Cancion VALUES (3, 'Titi Me Pregunto', 196, TO_DATE('2022-06-10','YYYY-MM-DD'), 3, 4);
INSERT INTO Cancion VALUES (4, 'Kind of Blue', 562, TO_DATE('1959-08-17','YYYY-MM-DD'), 4, 3);
INSERT INTO Cancion VALUES (5, 'Malamente', 194, TO_DATE('2017-05-26','YYYY-MM-DD'), 5, 1);
...
INSERT INTO Publicacion VALUES (1, 'Clásico atemporal de los 70s', TO_DATE('2024-05-01','YYYY-MM-DD'), 0, 0, 1, 1);
INSERT INTO Publicacion VALUES (2, 'Taylor vuelve a dominar',       TO_DATE('2024-06-15','YYYY-MM-DD'), 0, 0, 2, 2);
INSERT INTO Publicacion VALUES (3, 'El reggaeton sigue fuerte',     TO_DATE('2024-07-20','YYYY-MM-DD'), 0, 0, 3, 3);
INSERT INTO Publicacion VALUES (4, 'Miles Davis es inmortal',       TO_DATE('2024-08-01','YYYY-MM-DD'), 0, 0, 4, 4);
INSERT INTO Publicacion VALUES (5, 'Rosalia fusiona flamenco',      TO_DATE('2024-09-05','YYYY-MM-DD'), 0, 0, 1, 5);
...
INSERT INTO Historial_Musical VALUES (4, TO_DATE('2024-06-14','YYYY-MM-DD'), 'Para concentrarme', 'calmado',  4, 4);
INSERT INTO Historial_Musical VALUES (5, TO_DATE('2024-07-03','YYYY-MM-DD'), 'Descubrimiento nuevo', 'curioso',  5, 1);
...
-- Tipo incorrecto
INSERT INTO Cancion VALUES (99, 'Prueba Tipo', 'LARGA', TO_DATE('2020-01-01','YYYY-MM-DD'), 1, 1);

-- NOT NULL
INSERT INTO Cancion VALUES (99, NULL, 200, TO_DATE('2020-01-01','YYYY-MM-DD'), 1, 1);

-- PK duplicada
INSERT INTO Cancion VALUES (1, 'Copia song', 180, TO_DATE('2020-01-01','YYYY-MM-DD'), 1, 1);

-- FK inexistente (Artista)
INSERT INTO Cancion VALUES (20, 'Sin Artista', 180, TO_DATE('2020-01-01','YYYY-MM-DD'), 999, 1);

-- FK inexistente (Genero)
INSERT INTO Cancion VALUES (21, 'Sin Genero', 180, TO_DATE('2020-01-01','YYYY-MM-DD'), 1, 999);
...
-- PK duplicada
INSERT INTO Publicacion VALUES (1, 'Publicacion duplicada', SYSDATE, 0, 0, 2, NULL);

-- FK usuario inexistente
INSERT INTO Publicacion VALUES (20, 'Usuario inexistente', SYSDATE, 0, 0, 999, NULL);

-- FK canción inexistente
INSERT INTO Publicacion VALUES (21, 'Cancion adjunta inexistente', SYSDATE, 0, 0, 1, 999);

-- PK compuesta duplicada
INSERT INTO Publicacion_TipoContenido VALUES (1, 'cancion');

-- PK duplicada
INSERT INTO Historial_Musical VALUES (1, SYSDATE, 'Duplicado', 'feliz', 1, 1);

-- FK canción inexistente
INSERT INTO Historial_Musical VALUES (20, SYSDATE, NULL, 'feliz', 999, 1);

-- FK usuario inexistente
INSERT INTO Historial_Musical VALUES (21, SYSDATE, NULL, 'feliz', 1, 999);
...
-- FK usuario inexistente
INSERT INTO Recomendacion VALUES (21, SYSDATE, 'Usuario inexistente', 'directa', 999, 1, 2, 0);
...
-- FK origen inexistente
INSERT INTO ListaNegra VALUES (20, 999, 1, SYSDATE, 'Origen inexistente');

-- FK destino inexistente
INSERT INTO ListaNegra VALUES (21, 1, 999, SYSDATE, 'Destino inexistente');
